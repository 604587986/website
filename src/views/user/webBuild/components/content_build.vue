<template>
	<div>
		<filterFormForUser @search="handleSearch"></filterFormForUser>
		<PageHeadActionWrapper>
			<template v-slot:left>
				<a-button type="primary" size="small" @click="publishMore">发布选中项</a-button>
			</template>
	...
	methods: {
		...
		publishMore() {
			...
			if (ids && ids.length) {
				...
				buildContent(ajaxData).then(res => {
					this.$message.success(res.message);
				});
			} else {
