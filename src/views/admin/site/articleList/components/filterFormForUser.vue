	...
	<div class="filter-form">
		<a-form layout="inline" :form="form">
			...
			<a-form-item label="置顶状态">
				<a-select size="small" v-decorator="['pin_date']" placeholder="置顶状态" allowClear @change="nextSearch">
					<a-select-option v-for="item in pin_date_list" :value="item.value" :key="item.value">{{item.label}}</a-select-option>
				</a-select>
			</a-form-item>
			<a-form-item label="是否推荐">
				<a-select size="small" v-decorator="['recommend']" placeholder="是否推荐" allowClear @change="nextSearch">
					<a-select-option v-for="item in recommend_list" :value="item.value" :key="item.value">{{item.label}}</a-select-option>
				</a-select>
			</a-form-item>
			<a-form-item label="发布状态">
				<a-select size="small" v-decorator="['release_state']" placeholder="发布状态" allowClear @change="nextSearch">
					<a-select-option v-for="item in release_state_list" :value="item.value" :key="item.value">{{item.label}}</a-select-option>
				</a-select>
			</a-form-item>
